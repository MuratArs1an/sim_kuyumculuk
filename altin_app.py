...
def gold_prices():
    ...
    try:
        ...
        data.append({"urun": "Gram Altın (24 Ayar)",
                     ...
                     "satis": f"{gram_satis * 1.006 + 30:,.2f}"})
        ...
        data.append(sar_item("stl2",  "E. Çeyrek", satis_ek=30))
        data.append(sar_item("stl4",  "E. Yarım",  satis_ek=60))
        data.append(sar_item("stl6",  "E. Teklik", satis_ek=120))
